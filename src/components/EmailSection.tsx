        ...
        <section id="contact" className="grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative">
            ...
            <div className="z-10">
                ...
                <div className="socials flex flex-row gap-2">
                    <Link href="https://github.com/anomasahar"><Image src={github} alt="Github Icon" /></Link>
                    <Link href="https://www.linkedin.com/in/anoma-sahar/"><Image src={linkedIn} alt="Linkedin Icon" /></Link>
                </div>
            </div>
            <div>
                {emailSubmitted ? (
                    ...
                    <form className="flex flex-col" onSubmit={handleSubmit}>
                        ...
                        <button type="submit" className="bg-primary-500 hover:bg-primary-600 text-white font-medium py-2.5 px-5 rounded-lg w-full" disabled={loading}>
